...
namespace ImportContentFromRss.Content
{
    ...
    {
        public Person(ComponentData content, SessionAwareCoreServiceClient client)
            : base(content, client)
        {
        }

        public Person(SessionAwareCoreServiceClient client)
            : base(client)
        {
        ...
        public List<string> AlternateNames
        {
            ...
            set
            {
                ...
                {
                    Fields["AlternateNames"].AddValue(v);
                }
